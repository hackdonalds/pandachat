...
var require_stdin = __commonJS((exports, module) => {
  (function(global2, factory) {
    ...
    var arrayForEach = !STRICT_METHOD || !USES_TO_LENGTH$1 ? function forEach2(callbackfn) {
    ...
    var arrayLastIndexOf = FORCED$3 ? function lastIndexOf(searchElement) {
      ...
      var index2 = length - 1;
      if (arguments.length > 1)
        index2 = min$5(index2, toInteger(arguments[1]));
      if (index2 < 0)
    ...
    var arrayCopyWithin = [].copyWithin || function copyWithin(target, start) {
      ...
      var count = min$6((end === void 0 ? len : toAbsoluteIndex(end, len)) - from2, len - to);
      var inc = 1;
    ...
    createCommonjsModule(function(module2) {
      !function(global2) {
        ...
        runtime = global2.regeneratorRuntime = module2.exports;
        ...
        function defineIteratorMethods(prototype) {
          ["next", "throw", "return"].forEach(function(method2) {
            prototype[method2] = function(arg) {
        ...
        runtime.async = function(innerFn, outerFn, self2, tryLocsList) {
          var iter = new AsyncIterator(wrap2(innerFn, outerFn, self2, tryLocsList));
    ...
    var mocha = createCommonjsModule(function(module2, exports2) {
      ...
      Mocha.prototype.ui = function(ui2) {
        ...
        this.suite.on(EVENT_FILE_PRE_REQUIRE2, function(context2) {
          exports2.afterEach = context2.afterEach || context2.teardown;
          exports2.after = context2.after || context2.suiteTeardown;
          exports2.beforeEach = context2.beforeEach || context2.setup;
          exports2.before = context2.before || context2.suiteSetup;
          exports2.describe = context2.describe || context2.suite;
          exports2.it = context2.it || context2.test;
          exports2.xit = context2.xit || context2.test && context2.test.skip;
          exports2.setup = context2.setup || context2.beforeEach;
          exports2.suiteSetup = context2.suiteSetup || context2.before;
          exports2.suiteTeardown = context2.suiteTeardown || context2.after;
          exports2.suite = context2.suite || context2.describe;
          exports2.teardown = context2.teardown || context2.afterEach;
          exports2.test = context2.test || context2.it;
          exports2.run = context2.run;
        });
        return this;
      };

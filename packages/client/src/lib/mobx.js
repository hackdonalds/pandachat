...
var require_stdin = __commonJS((exports, module) => {
  (function(global2, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = global2 || self, factory(global2.mobx = {}));
    ...
    var Atom = function() {
      function Atom2(name) {
        ...
        this.lowestObserverState = exports2.IDerivationState.NOT_TRACKING;
      }
    ...
    })(exports2.IDerivationState || (exports2.IDerivationState = {}));
    var TraceMode;
    (function(TraceMode2) {
    ...
    function shouldCompute(derivation) {
      switch (derivation.dependenciesState) {
        case exports2.IDerivationState.UP_TO_DATE:
          return false;
        case exports2.IDerivationState.NOT_TRACKING:
        case exports2.IDerivationState.STALE:
          return true;
        case exports2.IDerivationState.POSSIBLY_STALE: {
          ...
          for (var i = 0; i < l; i++) {
            ...
            if (isComputedValue(obj)) {
              ...
              if (derivation.dependenciesState === exports2.IDerivationState.STALE) {
                untrackedEnd(prevUntracked);
                allowStateReadsEnd(prevAllowStateReads);
                return true;
              }
    ...
    function bindDependencies(derivation) {
      ...
      var lowestNewObservingDerivationState = exports2.IDerivationState.UP_TO_DATE;
      ...
      if (lowestNewObservingDerivationState !== exports2.IDerivationState.UP_TO_DATE) {
    ...
    function clearObserving(derivation) {
      ...
      derivation.dependenciesState = exports2.IDerivationState.NOT_TRACKING;
    }
    ...
    function changeDependenciesStateTo0(derivation) {
      if (derivation.dependenciesState === exports2.IDerivationState.UP_TO_DATE)
        return;
      derivation.dependenciesState = exports2.IDerivationState.UP_TO_DATE;
      var obs = derivation.observing;
      var i = obs.length;
      while (i--)
        obs[i].lowestObserverState = exports2.IDerivationState.UP_TO_DATE;
    }
    ...
    var ComputedValue = function() {
      function ComputedValue2(options) {
        this.dependenciesState = exports2.IDerivationState.NOT_TRACKING;
        this.observing = [];
        ...
        this.runId = 0;
        this.lastAccessedBy = 0;
        this.lowestObserverState = exports2.IDerivationState.UP_TO_DATE;
      ...
      ComputedValue2.prototype.trackAndCompute = function() {
        ...
        var oldValue = this.value;
        var wasSuspended = this.dependenciesState === exports2.IDerivationState.NOT_TRACKING;
    ...
    function hasObservers(observable2) {
      return observable2.observers && observable2.observers.size > 0;
    }
    ...
    function propagateChanged(observable2) {
      if (observable2.lowestObserverState === exports2.IDerivationState.STALE)
        return;
      observable2.lowestObserverState = exports2.IDerivationState.STALE;
      observable2.observers.forEach(function(d) {
        if (d.dependenciesState === exports2.IDerivationState.UP_TO_DATE) {
          if (d.isTracing !== TraceMode.NONE) {
            logTraceInfo(d, observable2);
          }
          d.onBecomeStale();
        }
        d.dependenciesState = exports2.IDerivationState.STALE;
      });
    }
    function propagateChangeConfirmed(observable2) {
      ...
      observable2.lowestObserverState = exports2.IDerivationState.STALE;
      observable2.observers.forEach(function(d) {
        if (d.dependenciesState === exports2.IDerivationState.POSSIBLY_STALE)
          d.dependenciesState = exports2.IDerivationState.STALE;
        else if (d.dependenciesState === exports2.IDerivationState.UP_TO_DATE)
          observable2.lowestObserverState = exports2.IDerivationState.UP_TO_DATE;
      });
    }
    function propagateMaybeChanged(observable2) {
      if (observable2.lowestObserverState !== exports2.IDerivationState.UP_TO_DATE)
        return;
      observable2.lowestObserverState = exports2.IDerivationState.POSSIBLY_STALE;
      observable2.observers.forEach(function(d) {
        if (d.dependenciesState === exports2.IDerivationState.UP_TO_DATE) {
          d.dependenciesState = exports2.IDerivationState.POSSIBLY_STALE;
          if (d.isTracing !== TraceMode.NONE) {
            logTraceInfo(d, observable2);
          }
          d.onBecomeStale();
    ...
    function decorate(thing, decorators) {
      ...
      var _loop_1 = function(prop2) {
        ...
        }), "Decorate: expected a decorator function or array of decorator functions for '" + prop2 + "'");
    ...
    function interceptReads(thing, propOrHandler, handler) {
      ...
      if (isObservableMap(thing) || isObservableArray(thing) || isObservableValue(thing)) {
        ...
        if (typeof propOrHandler !== "string")
          return fail(process.env.NODE_ENV !== "production" && "InterceptReads can only be used with a specific property, not with an object in general");
    ...
    function isComputed(value) {
      if (arguments.length > 1)
        return fail(process.env.NODE_ENV !== "production" && "isComputed expects only 1 argument. Use isObservableProp to inspect the observability of a property");
      return _isComputed(value);
    }
    function isComputedProp(value, propName) {
      if (typeof propName !== "string")
        return fail(process.env.NODE_ENV !== "production" && "isComputed expected a property name as second argument");
    ...
    function isObservable(value) {
      if (arguments.length !== 1)
        fail(process.env.NODE_ENV !== "production" && "isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property");
    ...
    function getAtom(thing, property) {
      if (typeof thing === "object" && thing !== null) {
        if (isObservableArray(thing)) {
          if (property !== void 0)
            fail(process.env.NODE_ENV !== "production" && "It is not possible to get index atoms from arrays");
        ...
        if (isObservableMap(thing)) {
          ...
          if (!observable2)
            fail(process.env.NODE_ENV !== "production" && "the entry '" + property + "' does not exist in the observable map '" + getDebugName(thing) + "'");
          return observable2;
        }
        initializeInstance(thing);
        ...
        if (isObservableObject(thing)) {
          ...
          if (!observable2)
            fail(process.env.NODE_ENV !== "production" && "no observable property '" + property + "' found on the observable object '" + getDebugName(thing) + "'");
          return observable2;
        }
    ...
    exports2.$mobx = $mobx;
    exports2.FlowCancellationError = FlowCancellationError;
    exports2.ObservableMap = ObservableMap;
    exports2.ObservableSet = ObservableSet;
    exports2.Reaction = Reaction;
    exports2._allowStateChanges = allowStateChanges;
    exports2._allowStateChangesInsideComputed = allowStateChangesInsideComputed;
    exports2._allowStateReadsEnd = allowStateReadsEnd;
    exports2._allowStateReadsStart = allowStateReadsStart;
    exports2._endAction = _endAction;
    exports2._getAdministration = getAdministration;
    exports2._getGlobalState = getGlobalState;
    exports2._interceptReads = interceptReads;
    exports2._isComputingDerivation = isComputingDerivation;
    exports2._resetGlobalState = resetGlobalState;
    exports2._startAction = _startAction;
    exports2.action = action;
    exports2.autorun = autorun;
    exports2.comparer = comparer;
    exports2.computed = computed;
    exports2.configure = configure;
    exports2.createAtom = createAtom;
    exports2.decorate = decorate;
    exports2.entries = entries;
    exports2.extendObservable = extendObservable;
    exports2.flow = flow;
    exports2.get = get;
    exports2.getAtom = getAtom;
    exports2.getDebugName = getDebugName;
    exports2.getDependencyTree = getDependencyTree;
    exports2.getObserverTree = getObserverTree;
    exports2.has = has;
    exports2.intercept = intercept;
    exports2.isAction = isAction;
    exports2.isArrayLike = isArrayLike;
    exports2.isBoxedObservable = isObservableValue;
    exports2.isComputed = isComputed;
    exports2.isComputedProp = isComputedProp;
    exports2.isFlowCancellationError = isFlowCancellationError;
    exports2.isObservable = isObservable;
    exports2.isObservableArray = isObservableArray;
    exports2.isObservableMap = isObservableMap;
    exports2.isObservableObject = isObservableObject;
    exports2.isObservableProp = isObservableProp;
    exports2.isObservableSet = isObservableSet;
    exports2.keys = keys;
    exports2.observable = observable;
    exports2.observe = observe;
    exports2.onBecomeObserved = onBecomeObserved;
    exports2.onBecomeUnobserved = onBecomeUnobserved;
    exports2.onReactionError = onReactionError;
    exports2.reaction = reaction;
    exports2.remove = remove;
    exports2.runInAction = runInAction;
    exports2.set = set;
    exports2.spy = spy;
    exports2.toJS = toJS;
    exports2.trace = trace;
    exports2.transaction = transaction;
    exports2.untracked = untracked;
